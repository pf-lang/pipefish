...
- A `pf-image` displays an image loaded from a resource file and updates itself whenever the file is changed. It has one method, `create`, giving the location of the image file.
