...
func TestDump(t *testing.T) { 
	...
	test := []test_helper.TestItem{
		...
		{`hub dump "big"`, "# Function dump of `big`\n\n## Code dump for function `big` with sig int\n\n@71 : asgm m275 <- m273  // Assign to memory.\n@72 : gtei m274 <- m275 m277  // Int comparison with >=.\n@73 : asgm m278 <- m274  // Assign to memory.\n@74 : qtru m278 @77  // Test true.\n@75 : asgm m280 <- m279  // Assign to memory.\n@76 : jmp @78  // Jump.\n@77 : asgm m280 <- m3  // Assign to memory.\n@78 : qsat m280 @81  // Test not `UNSAT`.\n@79 : asgm m282 <- m280  // Assign to memory.\n@80 : jmp @82  // Jump.\n@81 : asgm m282 <- m281  // Assign to memory.\n@82 : ret  // Return."},
		{`hub dump m "big"`, "# Function dump of `big`\n\n## Code dump for function `big` with sig int\n\n@71 : asgm m275 <- m273  // Assign to memory.\n@72 : gtei m274 <- m275 m277  // Int comparison with >=.\n@73 : asgm m278 <- m274  // Assign to memory.\n@74 : qtru m278 @77  // Test true.\n@75 : asgm m280 <- m279  // Assign to memory.\n@76 : jmp @78  // Jump.\n@77 : asgm m280 <- m3  // Assign to memory.\n@78 : qsat m280 @81  // Test not `UNSAT`.\n@79 : asgm m282 <- m280  // Assign to memory.\n@80 : jmp @82  // Jump.\n@81 : asgm m282 <- m281  // Assign to memory.\n@82 : ret  // Return.\n\n### Memory dump for function `big` with sig int`\n\nm273 : UNDEFINED VALUE::UNDEFINED VALUE!\nm274 : error::\x1b[31mError\x1b[39m: something unexpected has gone wrong at line \x1b[33m4:6-8\x1b[39m of \x1b[36m\"../hub/test-files/dump.pf\"\x1b[39m. \nm275 : UNDEFINED VALUE::UNDEFINED VALUE!\nm276 : BLING::>=\nm277 : int::100\nm278 : UNDEFINED VALUE::UNDEFINED VALUE!\nm279 : string::\"big\"\nm280 : UNDEFINED VALUE::UNDEFINED VALUE!\nm281 : string::\"small\"\nm282 : UNDEFINED VALUE::UNDEFINED VALUE!"},
		{`hub halt "dump"`, `OK`},
		{`hub quit`, "[32mOK[0m\n" + text.Logo() + "Thank you for using Pipefish. Have a nice day!"},
	}
	test_helper.RunHubTest(t, "default", test)
